...
{
  "$end", "error", "$undefined", "CNUMBER", "'+'", "'-'", "'*'", "'/'",
  "'\\n'", "'('", "')'", "$accept", "list", "exp", YY_NULLPTR
};
#endif
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4:
#line 23 "complejo_cal.y"
                     { print_(yyvsp[-1]); }
#line 1312 "y.tab.c"
    break;

  case 5:
#line 25 "complejo_cal.y"
                     { yyval = yyvsp[0];  }
#line 1318 "y.tab.c"
    break;

  case 6:
#line 26 "complejo_cal.y"
                      { yyval = add_(yyvsp[-2], yyvsp[0]);  }
#line 1324 "y.tab.c"
    break;

  case 7:
#line 27 "complejo_cal.y"
                      { yyval = sub_(yyvsp[-2], yyvsp[0]);  }
#line 1330 "y.tab.c"
    break;

  case 8:
#line 28 "complejo_cal.y"
                      { yyval = mul_(yyvsp[-2], yyvsp[0]);  }
#line 1336 "y.tab.c"
    break;

  case 9:
#line 29 "complejo_cal.y"
                      { yyval = div__(yyvsp[-2],yyvsp[0]);  }
#line 1342 "y.tab.c"
    break;

  case 10:
#line 30 "complejo_cal.y"
                      { yyval = yyvsp[-1];}
#line 1348 "y.tab.c"
    break;
